...
df1 = pd.read_csv("./iCAF_meta.txt", header=0, index_col=0, sep="\t")
df2 = pd.read_csv("./iCAF_AUCmatrix.txt", header=0, index_col=0, sep="\t")
...
total_df.to_csv("./iCAF_diff_TF_boxplot.txt", header=True, index=True, sep="\t")
